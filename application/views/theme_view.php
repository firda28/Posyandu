...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="<?php echo base_url(); ?>assets/img/karangrejo.png" style="height:100px, weight:50px">
    <link rel="icon" href="<?php echo base_url(); ?>assets/img/karangrejo.png" style="height:100px, weight:50px;">
</head>
